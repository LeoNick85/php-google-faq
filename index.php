...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Esercitazione #36 - Google FAQ in PHP</title>
    </head>
    <body>
        <header>
            <div id="header-up">
        ...
        <main>
            <?php
            for ($i = 0; $i < count($elenco_faq_it) ; $i++) {
                echo "<h2>" . $elenco_faq_it[$i]["question"] . "</h2>";
                echo "<p>" . $elenco_faq_it[$i]["answer"] . "</p>";
            }
            ?>
        </main>
        <footer>
